...
public class ResultRecorderToExcel implements WriteResult {


        private static final int ROWS = 33;
        private static final String[] MEASURES = {"F-measure", "F2-measure", "FSelectTime", "FGenerateTime",
                "FExecuteTime", "F2SelectTime", "F2GenerateTime", "F2ExecuteTime"};
    ...
    public ResultRecorderToExcel() {
        FArray = new ArrayList<Integer>();
    ...
    public void initializeMeasureArray(List<Integer> FArray, List<Integer> F2Array) {
        ...
        public void initializeMeasureAverageAndVariance(double FAverage, double F2Average, double FVariance, double F2Variance) {
