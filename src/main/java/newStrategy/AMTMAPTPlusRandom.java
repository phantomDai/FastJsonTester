 ...
 * @date 2019/12/24
 */
public class AMTMAPTPlusRandom implements Strategy{
    ...
    public void testing(int repeat) {
        ...
        //记录结果
        new WriteResult2text().recordResult("AMTMAPTPlusRandom", repeat,
        ...
        writeResult2Excel.writeResult("AMTMAPTPlusRandom", repeat);
    }
