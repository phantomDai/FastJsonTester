 ...
 * @date 2019/12/24
 */
public class AMTRAPTPlusPBMR implements Strategy{
    ...
    public void testing(int repeat) {
        ...
        //记录结果
        new WriteResult2text().recordResult("AMTRAPTPlusPBMR", repeat,
        ...
        writeResult2Excel.writeResult("AMTRAPTPlusPBMR", repeat);
    }
