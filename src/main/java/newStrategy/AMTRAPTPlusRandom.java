 ...
 * @date 2019/12/24
 */
public class AMTRAPTPlusRandom implements Strategy{
    /**产生度量标准的工厂*/
    ...
    public void testing(int repeat) {
        ...
        for (int o = 0; o < 30; o++) {
            ...
            System.out.println("repeat: " + String.valueOf(repeat) +
                    "的第 " + String.valueOf(o) + " 次循环");
            ...
            while(executeFlag){
                ...
                mapt.adjustMAPT(partitionIndex,partitionIndex,killedOne);
        ...
        //记录结果
        new WriteResult2text().recordResult("AMTRAPTPlusRandom", repeat,
        ...
        writeResult2Excel.writeResult("AMTRAPTPlusRandom", repeat);
    }
