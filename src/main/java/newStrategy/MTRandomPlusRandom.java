 ...
 * @date 2019/12/23
 */
public class MTRandomPlusRandom implements Strategy{
    ...
    public void testing(int repeat){
        ...
        for (int o = 0; o < 30; o++) {
            ...
            while(executeFlag){
                ...
                int testCaseIndex = random.nextInt(Constant.numberOfTestFrames);
        ...
        //记录结果
        new WriteResult2text().recordResult("MTRandomPlusRandom", repeat,
        ...
        writeResult2Excel.writeResult("MTRandomPlusRandom", repeat);
    }
