...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    protected mutants.v36.com.alibaba.fastjson.serializer.BeanContext fieldContext;
    ...
    public void writePrefix(mutants.v36.com.alibaba.fastjson.serializer.JSONSerializer serializer) throws IOException {
    ...
    public void writeValue(JSONSerializer serializer, Object propertyValue) throws Exception {
            ...
            if (fieldAnnotation != null && fieldAnnotation.serializeUsing() != Void.class) {
                ...
                if (format != null) {
                    if (runtimeFieldClass == double.class || runtimeFieldClass == Double.class) {
                        ...
                        fieldSerializer = new mutants.v36.com.alibaba.fastjson.serializer.FloatCodec(format);
                    }
                }
        ...
        if (fieldInfo.unwrapped) {
            ...
            if (valueSerializer instanceof mutants.v36.com.alibaba.fastjson.serializer.MapSerializer) {
                mutants.v36.com.alibaba.fastjson.serializer.MapSerializer mapSerializer = (MapSerializer) valueSerializer;
