...
public final class ListSerializer implements ObjectSerializer {
    ...
    public final void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType, int features)
        ...
        mutants.v36.com.alibaba.fastjson.serializer.SerialContext context = serializer.context;
                ...
                for (Object item : list) {
                    ...
                    if (item != null) {
                        if (serializer.containsReference(item)) {
                            ...
                            mutants.v36.com.alibaba.fastjson.serializer.SerialContext itemContext = new mutants.v36.com.alibaba.fastjson.serializer.SerialContext(context, object, fieldName, 0, 0);
                    ...
                    if (clazz == Integer.class) {
                        ...
                        if ((SerializerFeature.DisableCircularReferenceDetect.mask & features) != 0){
                            ...
                            if (!out.disableCircularReferenceDetect) {
                                mutants.v36.com.alibaba.fastjson.serializer.SerialContext itemContext = new SerialContext(context, object, fieldName, 0, 0);
                                serializer.context = itemContext;
                            }
