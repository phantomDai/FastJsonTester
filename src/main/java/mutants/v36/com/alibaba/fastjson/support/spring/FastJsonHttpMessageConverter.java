...
import mutants.v36.com.alibaba.fastjson.JSONPObject;
...
import mutants.v36.com.alibaba.fastjson.support.config.FastJsonConfig;
...
public class FastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object>//
    ...
    protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        try {
            ...
            if (value instanceof mutants.v36.com.alibaba.fastjson.support.spring.FastJsonContainer) {
                mutants.v36.com.alibaba.fastjson.support.spring.FastJsonContainer fastJsonContainer = (FastJsonContainer) value;
                PropertyPreFilters filters = fastJsonContainer.getFilters();
                allFilters.addAll(filters.getFilters());
                value = fastJsonContainer.getValue();
            }

            if (value instanceof mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue) {
