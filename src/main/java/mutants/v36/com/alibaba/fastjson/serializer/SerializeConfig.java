...
import mutants.v36.com.alibaba.fastjson.parser.deserializer.Jdk8DateCodec;
import mutants.v36.com.alibaba.fastjson.parser.deserializer.OptionalCodec;
import mutants.v36.com.alibaba.fastjson.serializer.*;
import mutants.v36.com.alibaba.fastjson.serializer.AdderSerializer;
import mutants.v36.com.alibaba.fastjson.serializer.ArraySerializer;
import mutants.v36.com.alibaba.fastjson.serializer.AtomicCodec;
import mutants.v36.com.alibaba.fastjson.serializer.AwtCodec;
import mutants.v36.com.alibaba.fastjson.serializer.BigDecimalCodec;
import mutants.v36.com.alibaba.fastjson.serializer.BigIntegerCodec;
import mutants.v36.com.alibaba.fastjson.serializer.BooleanCodec;
import mutants.v36.com.alibaba.fastjson.serializer.CalendarCodec;
import mutants.v36.com.alibaba.fastjson.serializer.CharacterCodec;
import mutants.v36.com.alibaba.fastjson.serializer.ClobSeriliazer;
import mutants.v36.com.alibaba.fastjson.serializer.CollectionCodec;
import mutants.v36.com.alibaba.fastjson.serializer.DateCodec;
import mutants.v36.com.alibaba.fastjson.serializer.EnumSerializer;
import mutants.v36.com.alibaba.fastjson.serializer.FieldSerializer;
import mutants.v36.com.alibaba.fastjson.serializer.FloatCodec;
import mutants.v36.com.alibaba.fastjson.serializer.GuavaCodec;
import mutants.v36.com.alibaba.fastjson.serializer.IntegerCodec;
import mutants.v36.com.alibaba.fastjson.serializer.ListSerializer;
import mutants.v36.com.alibaba.fastjson.serializer.LongCodec;
import mutants.v36.com.alibaba.fastjson.serializer.MapSerializer;
import mutants.v36.com.alibaba.fastjson.serializer.MiscCodec;
import mutants.v36.com.alibaba.fastjson.serializer.ReferenceCodec;
import mutants.v36.com.alibaba.fastjson.serializer.StringCodec;
import mutants.v36.com.alibaba.fastjson.spi.Module;
import mutants.v36.com.alibaba.fastjson.support.moneta.MonetaCodec;
import mutants.v36.com.alibaba.fastjson.support.springfox.SwaggerJsonSerializer;
import mutants.v36.com.alibaba.fastjson.util.*;
import mutants.v36.com.alibaba.fastjson.util.IdentityHashMap;
import mutants.v36.com.alibaba.fastjson.util.ServiceLoader;
import mutants.v36.com.alibaba.fastjson.serializer.*;
import mutants.v36.com.alibaba.fastjson.serializer.AdderSerializer;
import mutants.v36.com.alibaba.fastjson.serializer.ArraySerializer;
import mutants.v36.com.alibaba.fastjson.serializer.AtomicCodec;
...
public class SerializeConfig {
    ...
    private final JavaBeanSerializer createASMSerializer(SerializeBeanInfo beanInfo) throws Exception {
        ...
        for (int i = 0; i < serializer.sortedGetters.length; ++i) {
            ...
            if (fieldClass.isEnum()) {
                ...
                if (!(fieldSer instanceof mutants.v36.com.alibaba.fastjson.serializer.EnumSerializer)) {
    ...
    public final ObjectSerializer createJavaBeanSerializer(Class<?> clazz) {
	    ...
	    if (beanInfo.fields.length == 0 && Iterable.class.isAssignableFrom(clazz)) {
	        return mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance;
	    }
    ...
    private void initSerializers() {
        ...
        put(Byte.class, mutants.v36.com.alibaba.fastjson.serializer.IntegerCodec.instance);
        put(Short.class, mutants.v36.com.alibaba.fastjson.serializer.IntegerCodec.instance);
        ...
        put(Class.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);

        put(SimpleDateFormat.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        put(Currency.class, new mutants.v36.com.alibaba.fastjson.serializer.MiscCodec());
        put(TimeZone.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        put(InetAddress.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        put(Inet4Address.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        put(Inet6Address.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        put(InetSocketAddress.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        put(File.class, mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
        ...
        // atomic
        put(AtomicBoolean.class, mutants.v36.com.alibaba.fastjson.serializer.AtomicCodec.instance);
        put(AtomicInteger.class, mutants.v36.com.alibaba.fastjson.serializer.AtomicCodec.instance);
        put(AtomicLong.class, mutants.v36.com.alibaba.fastjson.serializer.AtomicCodec.instance);
        put(AtomicReference.class, mutants.v36.com.alibaba.fastjson.serializer.ReferenceCodec.instance);
        put(AtomicIntegerArray.class, mutants.v36.com.alibaba.fastjson.serializer.AtomicCodec.instance);
        put(AtomicLongArray.class, AtomicCodec.instance);

        put(WeakReference.class, mutants.v36.com.alibaba.fastjson.serializer.ReferenceCodec.instance);
        put(SoftReference.class, ReferenceCodec.instance);

        put(LinkedList.class, mutants.v36.com.alibaba.fastjson.serializer.CollectionCodec.instance);
    }
	...
	public void addFilter(Class<?> clazz, SerializeFilter filter) {
	    ...
	    if (serializer instanceof SerializeFilterable) {
	        ...
	        if (this != SerializeConfig.globalInstance) {
	            if (filterable == mutants.v36.com.alibaba.fastjson.serializer.MapSerializer.instance) {
	                mutants.v36.com.alibaba.fastjson.serializer.MapSerializer newMapSer = new mutants.v36.com.alibaba.fastjson.serializer.MapSerializer();
	...
	private ObjectSerializer getObjectWriter(Class<?> clazz, boolean create) {
        ...
        if (writer == null) {
            ...
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                put(clazz, writer = mutants.v36.com.alibaba.fastjson.serializer.DateCodec.instance);
                ...
                put(clazz, writer = mutants.v36.com.alibaba.fastjson.serializer.MiscCodec.instance);
            } else if (clazz.isEnum()) {
                JSONType jsonType = TypeUtils.getAnnotation(clazz, JSONType.class);
                if (jsonType != null && jsonType.serializeEnumAsJavaBean()) {
                    put(clazz, writer = createJavaBeanSerializer(clazz));
                } else {
                    put(clazz, writer = mutants.v36.com.alibaba.fastjson.serializer.EnumSerializer.instance);
                }
                ...
                if (className.startsWith("java.awt.") //
                    && mutants.v36.com.alibaba.fastjson.serializer.AwtCodec.support(clazz) //
                ) {
                    // awt
                    if (!awtError) {
                        try {
