...
import mutants.v36.com.alibaba.fastjson.asm.ClassWriter;
import mutants.v36.com.alibaba.fastjson.asm.FieldWriter;
import mutants.v36.com.alibaba.fastjson.asm.Label;
import mutants.v36.com.alibaba.fastjson.asm.MethodVisitor;
import mutants.v36.com.alibaba.fastjson.asm.MethodWriter;
import mutants.v36.com.alibaba.fastjson.asm.Opcodes;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, classNameType, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), null);
        ...
        return (mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer) instance;
    }
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        mw.visitFieldInsn(GETFIELD, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "beanInfo", desc(JavaBeanInfo.class));
        mw.visitVarInsn(ALOAD, context.var("typeName"));
        mw.visitMethodInsn(INVOKESTATIC, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "getSeeAlso"
                , "(" + desc(ParserConfig.class) + desc(JavaBeanInfo.class) + "Ljava/lang/String;)" + desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class));
        mw.visitVarInsn(ASTORE, context.var("userTypeDeser"));
        mw.visitVarInsn(ALOAD, context.var("userTypeDeser"));
        mw.visitTypeInsn(INSTANCEOF, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class));
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, //
                type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), //
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.parser.JSONLexerBase.VALUE_NULL);
                ...
                mw.visitTypeInsn(CHECKCAST, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer.class)); // cast
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "scanInt", "(C)I");
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "scanEnum",
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(itemClass)));
                    mw.visitVarInsn(ALOAD, 3);
                    mw.visitMethodInsn(INVOKESTATIC, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class),
                                       "parseArray",
                                       "(Ljava/util/Collection;" //
                                                     + desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class) //
                                                     + "L" + DefaultJSONParser + ";" //
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "getFieldType",
...
//                mw.visitInsn(POP);
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.parser.JSONLexerBase.END);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                _getFieldDeser(context, mw, fieldInfo);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "scanEnum"
                        , "(L" + JSONLexerBase + ";[C" + desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class) + ")Ljava/lang/Enum;");
                mw.visitTypeInsn(CHECKCAST, type(fieldClass)); // cast
                mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
...
//                mw.visitLabel(enumNull_);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass))); // cast
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class),
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ILOAD, 4);
        mw.visitMethodInsn(INVOKESPECIAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), //
                           "deserialze", //
                           "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "clazz", "Ljava/lang/Class;");
            mw.visitMethodInsn(INVOKESPECIAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "createInstance",
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitInsn(ICONST_0);
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
        mw.visitMethodInsn(INVOKEINTERFACE, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class), "deserialze",
        ...
        _getCollectionFieldItemDeser(context, mw, fieldInfo, itemType);
        if (isPrimitive) {
            mw.visitMethodInsn(INVOKEINTERFACE, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class), "getFastMatchToken", "()I");
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, type(ParserConfig.class), "getDeserializer",
                           "(Ljava/lang/reflect/Type;)" + desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.parser.DefaultJSONParser.NeedToResolve);
        ...
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.name);
        mw.visitMethodInsn(INVOKEVIRTUAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "getFieldDeserializer",
                           "(Ljava/lang/String;)" + desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer.class));
        mw.visitFieldInsn(PUTFIELD, type(ResolveTask.class), "fieldDeserializer", desc(FieldDeserializer.class));

        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.parser.DefaultJSONParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            mw.visitTypeInsn(CHECKCAST, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class)); // cast
            mw.visitVarInsn(ALOAD, 1);
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, type(mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "deserialze",
                               "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, type(fieldClass)); // cast
            mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
    ...
    private void _getFieldDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Label notNull_ = new Label();
        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, context.className, fieldInfo.name + "_asm_deser__", desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class));
        mw.visitJumpInsn(IFNONNULL, notNull_);
        ...
        mw.visitFieldInsn(PUTFIELD, context.className, fieldInfo.name + "_asm_deser__", desc(mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class));
