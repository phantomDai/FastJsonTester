...
import mutants.v36.com.alibaba.fastjson.asm.*;
...
import mutants.v36.com.alibaba.fastjson.util.ASMClassLoader;
...
import static mutants.v36.com.alibaba.fastjson.util.ASMUtils.desc;
import static mutants.v36.com.alibaba.fastjson.util.ASMUtils.type;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    static final String            JSONSerializer           = type(mutants.v36.com.alibaba.fastjson.serializer.JSONSerializer.class);
    static final String            ObjectSerializer         = type(mutants.v36.com.alibaba.fastjson.serializer.ObjectSerializer.class);
    static final String            ObjectSerializer_desc    = "L" + ObjectSerializer + ";";
    static final String            SerializeWriter          = type(mutants.v36.com.alibaba.fastjson.serializer.SerializeWriter.class);
    static final String            SerializeWriter_desc     = "L" + SerializeWriter + ";";
    static final String            JavaBeanSerializer       = type(mutants.v36.com.alibaba.fastjson.serializer.JavaBeanSerializer.class);
    static final String            JavaBeanSerializer_desc  = "L" + type(mutants.v36.com.alibaba.fastjson.serializer.JavaBeanSerializer.class) + ";";
    ...
    static class Context {
        ...
        private final mutants.v36.com.alibaba.fastjson.serializer.SerializeBeanInfo beanInfo;
        ...
        public Context(FieldInfo[] getters, //
                       mutants.v36.com.alibaba.fastjson.serializer.SerializeBeanInfo beanInfo, //
                       String className, //
                       boolean writeDirect, //
                       boolean nonContext){
    ...
    public mutants.v36.com.alibaba.fastjson.serializer.JavaBeanSerializer createJavaBeanSerializer(mutants.v36.com.alibaba.fastjson.serializer.SerializeBeanInfo beanInfo) throws Exception {
        ...
        for (FieldInfo fieldInfo : unsortedGetters) {
            if (fieldInfo.field == null //
                ...
                return new mutants.v36.com.alibaba.fastjson.serializer.JavaBeanSerializer(beanInfo);
            }
        }
        ...
        MethodVisitor mw = new MethodWriter(cw, ACC_PUBLIC, "<init>", "(" + desc(mutants.v36.com.alibaba.fastjson.serializer.SerializeBeanInfo.class) + ")V", null, null);
        mw.visitVarInsn(ALOAD, 0);
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKESPECIAL, JavaBeanSerializer, "<init>", "(" + desc(mutants.v36.com.alibaba.fastjson.serializer.SerializeBeanInfo.class) + ")V");
...
//                || fieldInfo.fieldClass.isEnum() //
            ...
            if (fieldInfo.method != null) {
                mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(fieldInfo.declaringClass)));
        ...
        if (jsonType != null) {
            for (mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature featrues : jsonType.serialzeFeatures()) {
                if (featrues == mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.DisableCircularReferenceDetect) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            if (context.writeDirect && !nonContext) {
                ...
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.DisableCircularReferenceDetect.mask);
        ...
        return (mutants.v36.com.alibaba.fastjson.serializer.JavaBeanSerializer) instance;
    }
            ...
            if (fieldClass == byte.class //
                ...
                if (elementClass == String.class //
                    ...
                    if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                        ...
                        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(elementClass)));
                        ...
                        if (context.writeDirect) {
                            ...
                            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(elementClass))); // fieldType
                    ...
                    if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc((Class<?>) elementType)));
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;");
                mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass)));
                ...
                if (context.writeDirect && Modifier.isPublic(fieldClass.getModifiers())) {
                    ...
                    mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass))); // fieldType
                    mw.visitLdcInsn(fieldInfo.serialzeFeatures); // features
                    mw.visitMethodInsn(INVOKEVIRTUAL, JavaBeanSerializer, "writeAsArrayNonContext", //
                                       "(L" + JSONSerializer + ";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
                    mw.visitJumpInsn(GOTO, instanceOfEnd_);
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, FieldInfo[] getters,
        ...
        if (!context.writeDirect) {
            ...
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.PrettyFormat.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
            ...
            if (hasMethod) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.IgnoreErrorGetter.mask);
                mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
        ...
        if ((context.beanInfo.features & mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.BeanToArray.mask) == 0) {
            Label endWriteAsArray_ = new Label();

            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.BeanToArray.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
        ...
        boolean writeClasName = (context.beanInfo.features & mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteClassName.mask) != 0;
    ...
    private void _enum(Class<?> clazz, MethodVisitor mw, FieldInfo fieldInfo, Context context) {
       ...
       if (context.writeDirect) {
            ...
            mw.visitVarInsn(ALOAD, context.var("enum"));
            mw.visitVarInsn(ALOAD, Context.fieldName);
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc((Class<?>) fieldInfo.fieldClass)));
            mw.visitLdcInsn(fieldInfo.serialzeFeatures);
            mw.visitMethodInsn(INVOKEVIRTUAL, JSONSerializer, "writeWithFieldName",
                    "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
        }
    ...
    private void _filters(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        if (property.fieldTransient) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.SkipTransientField.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        if (property.field == null) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.IgnoreNonFieldGetter.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
    ...
    private void _writeObject(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
        ...
        if (Modifier.isPublic(fieldClass.getModifiers()) //
            ...
            boolean disableCircularReferenceDetect = (fieldInfo.serialzeFeatures & mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.DisableCircularReferenceDetect.mask) != 0;
            boolean fieldBeanToArray = (fieldInfo.serialzeFeatures & mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.BeanToArray.mask) != 0;
        ...
        if (format != null) {
            ...
            if (fieldInfo.fieldType instanceof Class<?> //
                ...
                if (fieldInfo.fieldClass == String.class) {
                    mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(String.class)));
                } else {
                    mw.visitVarInsn(ALOAD, 0);
                    mw.visitFieldInsn(GETFIELD, context.className, fieldInfo.name + "_asm_fieldType",
                                      "Ljava/lang/reflect/Type;");
    ...
    private void _processValue(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, JavaBeanSerializer, "getBeanContext", "(I)" + desc(mutants.v36.com.alibaba.fastjson.serializer.BeanContext.class));
        mw.visitVarInsn(ALOAD, Context.obj);
        mw.visitVarInsn(ALOAD, Context.fieldName);
    ...
    private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
        ...
        int features = 0;
        if (annotation != null) {
            features = mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.of(annotation.serialzeFeatures());
        }
        JSONType jsonType = context.beanInfo.jsonType;
        if (jsonType != null) {
            features |= mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.of(jsonType.serialzeFeatures());
        }

        int writeNullFeatures;
        if (propertyClass == String.class) {
            writeNullFeatures = mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.getMask();
        } else if (Number.class.isAssignableFrom(propertyClass)) {
            writeNullFeatures = mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullNumberAsZero.getMask();
        } else if (Collection.class.isAssignableFrom(propertyClass)) {
            writeNullFeatures = mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullListAsEmpty.getMask();
        } else if (Boolean.class == propertyClass) {
            writeNullFeatures = mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullBooleanAsFalse.getMask();
        } else {
            writeNullFeatures = mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WRITE_MAP_NULL_FEATURES;
        }
        ...
        if (propertyClass == String.class || propertyClass == Character.class) {
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.mask);
        } else if (Number.class.isAssignableFrom(propertyClass)) {
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullNumberAsZero.mask);
        } else if (propertyClass == Boolean.class) {
            mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.serializer.SerializerFeature.WriteNullBooleanAsFalse.mask);
    ...
    private void _getListFieldItemSer(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> itemType) {
        ...
        mw.visitVarInsn(ALOAD, 0); // this
        mw.visitVarInsn(ALOAD, Context.serializer);
        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(itemType)));
    ...
    private void _getFieldSer(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        ...
        mw.visitVarInsn(ALOAD, 0); // this
        mw.visitVarInsn(ALOAD, Context.serializer);
        mw.visitLdcInsn(mutants.v36.com.alibaba.fastjson.asm.Type.getType(desc(fieldInfo.fieldClass)));
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONSerializer, "getObjectWriter",
                           "(Ljava/lang/Class;)" + ObjectSerializer_desc);
