...
import mutants.v36.com.alibaba.fastjson.util.ParameterizedTypeImpl;
...
public class TypeUtils{
    ...
    static{
        try{
            TypeUtils.compatibleWithJavaBean = "true".equals(mutants.v36.com.alibaba.fastjson.util.IOUtils.getStringProperty(mutants.v36.com.alibaba.fastjson.util.IOUtils.FASTJSON_COMPATIBLEWITHJAVABEAN));
            TypeUtils.compatibleWithFieldName = "true".equals(mutants.v36.com.alibaba.fastjson.util.IOUtils.getStringProperty(mutants.v36.com.alibaba.fastjson.util.IOUtils.FASTJSON_COMPATIBLEWITHFIELDNAME));
        } catch(Throwable e){
            // skip
        }
    }
...
//    }
    ...
    public static Date castToDate(Object value, String format){
        ...
        if(value instanceof Date){ // ʹ��Ƶ����ߵģ�Ӧ���ȴ���
            return (Date) value;
        }
    ...
    public static java.sql.Date castToSqlDate(Object value){
        ...
        if(longValue <= 0){
            throw new JSONException("can not cast to Date, value : " + value); // TODO ���� 1970-01-01 ֮ǰ��ʱ�䴦��
        }
    ...
    public static byte[] castToBytes(Object value){
        ...
        if(value instanceof String){
            return mutants.v36.com.alibaba.fastjson.util.IOUtils.decodeBase64((String) value);
        }
        throw new JSONException("can not cast to byte[], value : " + value);
    }
    ...
    private static void addBaseClassMappings(){
        ...
        Class<?>[] classes = new Class[]{
                ...
                JSONObject.class,
                mutants.v36.com.alibaba.fastjson.JSONPObject.class,
                mutants.v36.com.alibaba.fastjson.JSONArray.class,
        };
    ...
    public static SerializeBeanInfo buildBeanInfo(Class<?> beanType //
        ...
        List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldInfoList = fieldBased
                ? computeGettersWithFieldBase(beanType, aliasMap, false, propertyNamingStrategy) //
                : computeGetters(beanType, jsonType, aliasMap, fieldCacheMap, false, propertyNamingStrategy);
        mutants.v36.com.alibaba.fastjson.util.FieldInfo[] fields = new mutants.v36.com.alibaba.fastjson.util.FieldInfo[fieldInfoList.size()];
        fieldInfoList.toArray(fields);
        mutants.v36.com.alibaba.fastjson.util.FieldInfo[] sortedFields;
        List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> sortedFieldList;
        if(orders != null && orders.length != 0){
            ...
            sortedFieldList = new ArrayList<mutants.v36.com.alibaba.fastjson.util.FieldInfo>(fieldInfoList);
            Collections.sort(sortedFieldList);
        }
        sortedFields = new mutants.v36.com.alibaba.fastjson.util.FieldInfo[sortedFieldList.size()];
    ...
    public static List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> computeGettersWithFieldBase(
            Class<?> clazz, //
            Map<String,String> aliasMap, //
            boolean sorted, //
            PropertyNamingStrategy propertyNamingStrategy){
        Map<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap = new LinkedHashMap<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo>();
    ...
    public static List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> computeGetters(Class<?> clazz, Map<String,String> aliasMap){
        return computeGetters(clazz, aliasMap, true);
    }

    public static List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> computeGetters(Class<?> clazz, Map<String,String> aliasMap, boolean sorted){
    ...
    public static List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> computeGetters(Class<?> clazz, //
                                                                           JSONType jsonType, //
                                                                           Map<String,String> aliasMap, //
        ...
        for(Method method : methods){
            ...
            /**
             *  ��������Ի��߷����ϴ���JSONFieldע�⣬���Ҷ�����name���ԣ��������ϵ�propertyNamingStrategy����Ϊ׼���Դ��ֶε�JSONField��name����Ϊ׼��
             */
            ...
            if(annotation != null){
                ...
                if(annotation.name().length() != 0){
                    ...
                    mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, method, null, clazz, null, ordinal,
            ...
            if(methodName.startsWith("get")){
                ...
                mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, method, field, clazz, null, ordinal, serialzeFeatures, parserFeatures,
    ...
    private static List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> getFieldInfos(Class<?> clazz, boolean sorted, Map<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap){
        List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldInfoList = new ArrayList<mutants.v36.com.alibaba.fastjson.util.FieldInfo>();
        String[] orders = null;
        ...
        if(orders != null && orders.length > 0){
            LinkedHashMap<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo> map = new LinkedHashMap<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo>(fieldInfoList.size());
            for(mutants.v36.com.alibaba.fastjson.util.FieldInfo field : fieldInfoMap.values()){
            ...
            for(mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo : fieldInfoMap.values()){
    ...
    private static void computeFields(
            ...
            Map<String,String> aliasMap, //
            PropertyNamingStrategy propertyNamingStrategy, //
            Map<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap, //
            Field[] fields){
        for(Field field : fields){
            ...
            if(!fieldInfoMap.containsKey(propertyName)){
                mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, null, field, clazz, null, ordinal, serialzeFeatures, parserFeatures,
    ...
    private static boolean isJSONTypeIgnore(Class<?> clazz, String propertyName){
        JSONType jsonType = TypeUtils.getAnnotation(clazz,JSONType.class);
        if(jsonType != null){
            // 1������ includes ֧�֣���� JSONType ͬʱ������includes �� ignores ���ԣ�����includesΪ׼��
            // 2��������Ϊ���ڴ�Сд���е�Java��JS���ԣ�ʹ�� equals() �� equalsIgnoreCase() ���ã��Ķ���Ψһ���վ����������Ե�����
            // ���������ſ�����Ӧ�ö����ϸ��մ�Сд���еķ�ʽ�����������õ�
