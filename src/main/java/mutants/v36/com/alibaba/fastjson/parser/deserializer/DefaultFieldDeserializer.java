...
import mutants.v36.com.alibaba.fastjson.parser.deserializer.ContextObjectDeserializer;
...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    protected mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeserilizer;
    ...
    public mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer getFieldValueDeserilizer(ParserConfig config) {
        if (fieldValueDeserilizer == null) {
            JSONField annotation = fieldInfo.getAnnotation();
            if (annotation != null && annotation.deserializeUsing() != Void.class) {
                Class<?> deserializeUsing = annotation.deserializeUsing();
                try {
                    fieldValueDeserilizer = (mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer) deserializeUsing.newInstance();
                } catch (Exception ex) {
    ...
    public void parseField(DefaultJSONParser parser, Object object, Type objectType, Map<String, Object> fieldValues) {
        ...
        Object value;
        if (fieldValueDeserilizer instanceof mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer && fieldInfo.parserFeatures != 0) {
            mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer javaBeanDeser = (JavaBeanDeserializer) fieldValueDeserilizer;
