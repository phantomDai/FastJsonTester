...
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToString;
 ...
 */
public class JSONArray extends mutants.v36.com.alibaba.fastjson.JSON implements List<Object>, Cloneable, RandomAccess, Serializable {
    ...
    public <T> T getObject(int index, Type type) {
        ...
        if (type instanceof Class) {
            ...
            String json = mutants.v36.com.alibaba.fastjson.JSON.toJSONString(obj);
