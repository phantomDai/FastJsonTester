...
import mutants.v36.com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask;
...
import mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer;
import mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer;
import mutants.v36.com.alibaba.fastjson.parser.deserializer.MapDeserializer;
...
public class JavaBeanDeserializer implements mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer {

    private final mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer[]   fieldDeserializers;
    protected final mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer[] sortedFieldDeserializers;
    protected final Class<?>            clazz;
    public final JavaBeanInfo           beanInfo;
    private ConcurrentMap<String, Object> extraFieldDeserializers;

    private final Map<String, mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer> alterNameFieldDeserializers;
    private Map<String, mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer> fieldDeserializerMap;
    ...
    public JavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo){
        ...
        Map<String, mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer> alterNameFieldDeserializers = null;
        sortedFieldDeserializers = new mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer[beanInfo.sortedFields.length];
        for (int i = 0, size = beanInfo.sortedFields.length; i < size; ++i) {
            FieldInfo fieldInfo = beanInfo.sortedFields[i];
            mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = config.createFieldDeserializer(config, beanInfo, fieldInfo);

            sortedFieldDeserializers[i] = fieldDeserializer;

            if (size > 128) {
                if (fieldDeserializerMap == null) {
                    fieldDeserializerMap = new HashMap<String, mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer>();
                }
            ...
            for (String name : fieldInfo.alternateNames) {
                if (alterNameFieldDeserializers == null) {
                    alterNameFieldDeserializers = new HashMap<String, mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer>();
                }
        ...
        fieldDeserializers = new mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer[beanInfo.fields.length];
        for (int i = 0, size = beanInfo.fields.length; i < size; ++i) {
            FieldInfo fieldInfo = beanInfo.fields[i];
            mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = getFieldDeserializer(fieldInfo.name);
            fieldDeserializers[i] = fieldDeserializer;
        }
    }

    public mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer getFieldDeserializer(String key) {
        return getFieldDeserializer(key, null);
    }

    public mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer getFieldDeserializer(String key, int[] setFlags) {
        if (key == null) {
            return null;
        }

        if (fieldDeserializerMap != null) {
            mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = fieldDeserializerMap.get(key);
    ...
    public mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer getFieldDeserializer(long hash) {
    ...
    public <T> T deserialzeArrayMapping(DefaultJSONParser parser, Type type, Object fieldName, Object object) {
        ...
        if ((typeName = lexer.scanTypeName(parser.symbolTable)) != null) {
            mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer deserializer = getSeeAlso(parser.getConfig(), this.beanInfo, typeName);
            Class<?> userType = null;
        ...
        for (int i = 0, size = sortedFieldDeserializers.length; i < size; ++i) {
            ...
            mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = sortedFieldDeserializers[i];
            ...
            if (fieldClass == int.class) {
                ...
                if (ch == '\"' || ch == 'n') {
                    ...
                    mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer enumDeser = (mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer) ((DefaultFieldDeserializer) fieldDeser).getFieldValueDeserilizer(parser.getConfig());
    ...
    protected <T> T deserialze(DefaultJSONParser parser, // 
        ...
        try {
            ...
            for (int fieldIndex = 0, notMatchCount = 0;; fieldIndex++) {
                String key = null;
                mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = null;
                ...
                if (fieldDeser != null) {
                    ...
                    if (customDeserilizer && lexer.matchField(name_chars)) {
                        ...
                        if (lexer.matchStat > 0) {
                            ...
                            && parser.getConfig().getDeserializer(fieldClass) instanceof mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer
                            && (feildAnnotation == null || feildAnnotation.deserializeUsing() == Void.class)
                            ) {
                        if (fieldDeser instanceof DefaultFieldDeserializer) {
                            mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeserilizer = ((DefaultFieldDeserializer) fieldDeser).fieldValueDeserilizer;
                ...
                if (!matchField) {
                    ...
                    if ((typeKey != null && typeKey.equals(key))
                        ...
                        if (lexer.token() == JSONToken.LITERAL_STRING) {
                            ...
                            mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer deserializer = getSeeAlso(config, this.beanInfo, typeName);
                            Class<?> userType = null;
                            ...
                            if (deserializer instanceof JavaBeanDeserializer) {
                                ...
                                if (typeKey != null) {
                                    mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer typeKeyFieldDeser = javaBeanDeserializer.getFieldDeserializer(typeKey);
                ...
                if (beanInfo.creatorConstructor != null) {
                    ...
                    if (paramNames != null) {
                        for (Map.Entry<String, Object> entry : fieldValues.entrySet()) {
                            mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = getFieldDeserializer(entry.getKey());
                            if (fieldDeserializer != null) {
    ...
    protected Enum scanEnum(JSONLexerBase lexer, char[] name_chars, mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeserilizer) {
        mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer enumDeserializer = null;
        if (fieldValueDeserilizer instanceof mutants.v36.com.alibaba.fastjson.parser.deserializer.EnumDeserializer) {
    ...
    public boolean parseField(DefaultJSONParser parser, String key, Object object, Type objectType,
        ...
        mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer;
        ...
        if (fieldDeserializer == null
            ...
            if (deserOrField != null) {
                if (deserOrField instanceof mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer) {
                    fieldDeserializer = ((mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer) deserOrField);
                } else {
        ...
        if (fieldDeserializer == null) {
            ...
            for (int i = 0; i < this.sortedFieldDeserializers.length; i++) {
                mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = this.sortedFieldDeserializers[i];
                ...
                if (fieldInfo.unwrapped //
                    ...
                    if (fieldInfo.field != null) {
                        ...
                        mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeser = defaultFieldDeserializer.getFieldValueDeserilizer(parser.getConfig());
                        if (fieldValueDeser instanceof JavaBeanDeserializer) {
                            ...
                            mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer unwrappedFieldDeser = javaBeanFieldValueDeserializer.getFieldDeserializer(key);
                        ...
                        } else if (fieldValueDeser instanceof mutants.v36.com.alibaba.fastjson.parser.deserializer.MapDeserializer) {
                            mutants.v36.com.alibaba.fastjson.parser.deserializer.MapDeserializer javaBeanFieldValueDeserializer = (MapDeserializer) fieldValueDeser;
    ...
    public mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer smartMatch(String key) {
        return smartMatch(key, null);
    }

    public mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer smartMatch(String key, int[] setFlags) {
        if (key == null) {
            return null;
        }
        
        mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = getFieldDeserializer(key, setFlags);
    ...
    public Object createInstance(Map<String, Object> map, ParserConfig config) //
        ...
        if (beanInfo.creatorConstructor == null && beanInfo.factoryMethod == null) {
            ...
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                ...
                mutants.v36.com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = smartMatch(key);
                if (fieldDeser == null) {
                    continue;
                }
    ...
    protected static JavaBeanDeserializer getSeeAlso(ParserConfig config, JavaBeanInfo beanInfo, String typeName) {
        ...
        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
            mutants.v36.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer seeAlsoDeser = config.getDeserializer(seeAlsoClass);
