package mutants.v36.com.alibaba.fastjson.support.jaxrs;

import mutants.v36.com.alibaba.fastjson.support.jaxrs.FastJsonFeature;
...
public class FastJsonAutoDiscoverable implements AutoDiscoverable {
    ...
    public void configure(final FeatureContext context) {
        ...
        // Register FastJson.
        if (!config.isRegistered(mutants.v36.com.alibaba.fastjson.support.jaxrs.FastJsonFeature.class) && autoDiscover) {
