...
import mutants.v36.com.alibaba.fastjson.support.spring.FastJsonpHttpMessageConverter4;
import mutants.v36.com.alibaba.fastjson.support.spring.JSONPResponseBodyAdvice;
import mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue;
import mutants.v36.com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import mutants.v36.com.alibaba.fastjson.support.spring.FastJsonpHttpMessageConverter4;
import mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue;
...
public class FastJsonpResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue container = getOrCreateContainer(body);
        beforeBodyWriteInternal(container, selectedContentType, returnType, request, response);
        return container;
    }

    /**
     * Wrap the body in a {@link mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue} value container (for providing
     * additional serialization instructions) or simply cast it if already wrapped.
     */
    protected mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue getOrCreateContainer(Object body) {
        return (body instanceof mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue ? (mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue) body : new mutants.v36.com.alibaba.fastjson.support.spring.MappingFastJsonValue(body));
    }
