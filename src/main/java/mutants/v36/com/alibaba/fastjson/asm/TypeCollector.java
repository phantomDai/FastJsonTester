...
import mutants.v36.com.alibaba.fastjson.asm.MethodCollector;
...
public class TypeCollector {
    private static String JSONType = ASMUtils.desc(mutants.v36.com.alibaba.fastjson.annotation.JSONType.class);
    ...
    protected MethodCollector visitMethod(int access, String name, String desc) {
        ...
        mutants.v36.com.alibaba.fastjson.asm.Type[] argTypes = mutants.v36.com.alibaba.fastjson.asm.Type.getArgumentTypes(desc);
        int longOrDoubleQuantity = 0;
        for (mutants.v36.com.alibaba.fastjson.asm.Type t : argTypes) {
