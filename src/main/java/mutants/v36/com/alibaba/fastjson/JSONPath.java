...
import mutants.v36.com.alibaba.fastjson.parser.*;
...
//            
    ...
    public static Object read(String json, String path) {
        return compile(path)
                .eval(
                        mutants.v36.com.alibaba.fastjson.JSON.parse(json)
                );
    }
    ...
    public static Object extract(String json, String path) {
        return extract(json, path, ParserConfig.global, mutants.v36.com.alibaba.fastjson.JSON.DEFAULT_PARSER_FEATURE);
    }
...
//            }
    ...
    protected Object getPropertyValue(Object currentObject, String propertyName, long propertyNameHash) {
        ...
        if (currentObject instanceof String) {
            try {
                JSONObject object = mutants.v36.com.alibaba.fastjson.JSON.parseObject((String) currentObject);
