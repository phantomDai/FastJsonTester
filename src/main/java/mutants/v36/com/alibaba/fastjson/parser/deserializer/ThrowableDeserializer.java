...
public class ThrowableDeserializer extends mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
        ...
        if (otherValues != null) {
            mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer exBeanDeser = null;
            ...
            if (exClass != null) {
                if (exClass == clazz) {
                    ...
                    if (exDeser instanceof mutants.v36.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) {
