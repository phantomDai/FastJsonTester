...
import mutants.v36.com.alibaba.fastjson.PropertyNamingStrategy;
import mutants.v36.com.alibaba.fastjson.annotation.JSONCreator;
import mutants.v36.com.alibaba.fastjson.annotation.JSONField;
import mutants.v36.com.alibaba.fastjson.annotation.JSONPOJOBuilder;
import mutants.v36.com.alibaba.fastjson.annotation.JSONType;
...
import mutants.v36.com.alibaba.fastjson.util.ASMUtils;
...
public class JavaBeanInfo {
    ...
    public final mutants.v36.com.alibaba.fastjson.util.FieldInfo[] fields;
    public final mutants.v36.com.alibaba.fastjson.util.FieldInfo[] sortedFields;
    ...
    public JavaBeanInfo(Class<?> clazz, //
                        ...
                        Method buildMethod, //
                        JSONType jsonType, //
                        List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldList) {
        this.clazz = clazz;
        this.builderClass = builderClass;
        this.defaultConstructor = defaultConstructor;
        this.creatorConstructor = creatorConstructor;
        this.factoryMethod = factoryMethod;
        this.parserFeatures = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getParserFeatures(clazz);
        ...
        fields = new mutants.v36.com.alibaba.fastjson.util.FieldInfo[fieldList.size()];
        fieldList.toArray(fields);

        mutants.v36.com.alibaba.fastjson.util.FieldInfo[] sortedFields = new mutants.v36.com.alibaba.fastjson.util.FieldInfo[fields.length];
        if (orders != null) {
            LinkedHashMap<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo> map = new LinkedHashMap<String, mutants.v36.com.alibaba.fastjson.util.FieldInfo>(fieldList.size());
            for (mutants.v36.com.alibaba.fastjson.util.FieldInfo field : fields) {
                map.put(field.name, field);
            }
            int i = 0;
            for (String item : orders) {
                mutants.v36.com.alibaba.fastjson.util.FieldInfo field = map.get(item);
                if (field != null) {
                    sortedFields[i++] = field;
                    map.remove(item);
                }
            }
            for (mutants.v36.com.alibaba.fastjson.util.FieldInfo field : map.values()) {
                sortedFields[i++] = field;
            }
        } else {
        ...
        if (creatorConstructor != null) {
            ...
            kotlin = mutants.v36.com.alibaba.fastjson.util.TypeUtils.isKotlin(clazz);
            if (kotlin) {
                this.creatorConstructorParameters = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                try {
                ...
                Annotation[][] paramAnnotationArrays = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getParameterAnnotations(creatorConstructor);
                ...
                if (!match) {
                    this.creatorConstructorParameters = mutants.v36.com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                }
            }
        }
    }

    private static mutants.v36.com.alibaba.fastjson.util.FieldInfo getField(List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldList, String propertyName) {
        for (mutants.v36.com.alibaba.fastjson.util.FieldInfo item : fieldList) {
    ...
    static boolean add(List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldList, mutants.v36.com.alibaba.fastjson.util.FieldInfo field) {
        for (int i = fieldList.size() - 1; i >= 0; --i) {
            mutants.v36.com.alibaba.fastjson.util.FieldInfo item = fieldList.get(i);
    ...
    public static JavaBeanInfo build(Class<?> clazz, Type type, PropertyNamingStrategy propertyNamingStrategy) {
        return build(clazz, type, propertyNamingStrategy, false, mutants.v36.com.alibaba.fastjson.util.TypeUtils.compatibleWithJavaBean, false);
    }
    ...
    public static JavaBeanInfo build(Class<?> clazz //
        ...
        JSONType jsonType = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(clazz,JSONType.class);
        if (jsonType != null) {
        ...
        boolean kotlin = mutants.v36.com.alibaba.fastjson.util.TypeUtils.isKotlin(clazz);
        ...
        List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldList = new ArrayList<mutants.v36.com.alibaba.fastjson.util.FieldInfo>();
        ...
        if (fieldBased) {
            ...
            if (defaultConstructor != null) {
                mutants.v36.com.alibaba.fastjson.util.TypeUtils.setAccessible(defaultConstructor);
            }
        ...
        if ((defaultConstructor == null && builderClass == null) || isInterfaceOrAbstract) {
            ...
            if (creatorConstructor != null && !isInterfaceOrAbstract) { // ���ڱ�� JSONCreator ע��Ĺ��췽��
                mutants.v36.com.alibaba.fastjson.util.TypeUtils.setAccessible(creatorConstructor);
                ...
                if (types.length > 0) {
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        if (fieldAnnotation != null) {
                            field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, fieldAnnotation.name(), declaredFields);
                        ...
                        if (fieldName == null || fieldName.length() == 0) {
                            if (lookupParameterNames == null) {
                                lookupParameterNames = mutants.v36.com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                            }
                        ...
                        if (field == null) {
                            if (lookupParameterNames == null) {
                                if (kotlin) {
                                    lookupParameterNames = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                                } else {
                                    lookupParameterNames = mutants.v36.com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                                }
                            }
                            ...
                            if (lookupParameterNames.length > i) {
                                ...
                                field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, parameterName, declaredFields);
                            }
                        }

                        mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = new mutants.v36.com.alibaba.fastjson.util.FieldInfo(fieldName, clazz, fieldClass, fieldType, field,
                ...
                mutants.v36.com.alibaba.fastjson.util.TypeUtils.setAccessible(factoryMethod);

                String[] lookupParameterNames = null;
                Class<?>[] types = factoryMethod.getParameterTypes();
                if (types.length > 0) {
                    Annotation[][] paramAnnotationArrays = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getParameterAnnotations(factoryMethod);
                    for (int i = 0; i < types.length; ++i) {
                        Annotation[] paramAnnotations = paramAnnotationArrays[i];
                        JSONField fieldAnnotation = null;
                        for (Annotation paramAnnotation : paramAnnotations) {
                        ...
                        if (fieldAnnotation == null && !(jacksonCompatible && mutants.v36.com.alibaba.fastjson.util.TypeUtils.isJacksonCreator(factoryMethod))) {
                        ...
                        if (fieldName == null || fieldName.length() == 0) {
                            if (lookupParameterNames == null) {
                                lookupParameterNames = mutants.v36.com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(factoryMethod);
                            }
                            fieldName = lookupParameterNames[i];
                        }
                        ...
                        Field field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, fieldName, declaredFields);
                        mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = new mutants.v36.com.alibaba.fastjson.util.FieldInfo(fieldName, clazz, fieldClass, fieldType, field,
                                ordinal, serialzeFeatures, parserFeatures);
                        add(fieldList, fieldInfo);
                    }
                ...
                if (kotlin && constructors.length > 0) {
                    paramNames = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                    creatorConstructor = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getKoltinConstructor(constructors, paramNames);
                    mutants.v36.com.alibaba.fastjson.util.TypeUtils.setAccessible(creatorConstructor);
                } else {
                    ...
                    for (Constructor constructor : constructors) {
                        ...
                        if (className.equals("org.springframework.security.web.authentication.WebAuthenticationDetails")) {
                            if (parameterTypes.length == 2 && parameterTypes[0] == String.class && parameterTypes[1] == String.class) {
                                ...
                                paramNames = mutants.v36.com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(constructor);
                                break;
                            }
                        }
                ...
                if (paramNames != null
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        Class<?> fieldClass = types[i];
                        Type fieldType = creatorConstructor.getGenericParameterTypes()[i];
                        Field field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, paramName, declaredFields);
                        if (field != null) {
                            if (fieldAnnotation == null) {
                                fieldAnnotation = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(field, JSONField.class);
                            }
                        }
                        ...
                        mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = new mutants.v36.com.alibaba.fastjson.util.FieldInfo(paramName, clazz, fieldClass, fieldType, field,
                                ordinal, serialzeFeatures, parserFeatures);
                        add(fieldList, fieldInfo);
                    }
        ...
        if (builderClass != null) {
            ...
            JSONPOJOBuilder builderAnno = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(builderClass, JSONPOJOBuilder.class);
            if (builderAnno != null) {
            ...
            for (Method method : builderClass.getMethods()) {
                ...
                JSONField annotation = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(method, JSONField.class);

                if (annotation == null) {
                    annotation = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getSuperMethodAnnotation(clazz, method);
                }
                ...
                if (annotation != null) {
                    ...
                    if (annotation.name().length() != 0) {
                        ...
                        add(fieldList, new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, method, null, clazz, type, ordinal, serialzeFeatures, parserFeatures,
            ...
            if (builderClass != null) {
                JSONPOJOBuilder builderAnnotation = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(builderClass, JSONPOJOBuilder.class);
                ...
                mutants.v36.com.alibaba.fastjson.util.TypeUtils.setAccessible(buildMethod);
            }
        }
        ...
        for (Method method : methods) { //
            ...
            if (annotation != null
                ...
                add(fieldList, new mutants.v36.com.alibaba.fastjson.util.FieldInfo("", method, null, clazz, type, ordinal,
            ...
            if (annotation == null && !methodName.startsWith("set") || builderClass != null) { // TODO "set"���жϷ��� JSONField ע����棬��˼������� setter ������� JSONField ע�⣿
                continue;
            }
            ...
            if (Character.isUpperCase(c3) //
                ...
                if (mutants.v36.com.alibaba.fastjson.util.TypeUtils.compatibleWithJavaBean) {
                    propertyName = mutants.v36.com.alibaba.fastjson.util.TypeUtils.decapitalize(methodName.substring(3));
                } else {
                    propertyName = Character.toLowerCase(methodName.charAt(3)) + methodName.substring(4);
                }
            } else if (c3 == '_') {
                propertyName = methodName.substring(4);
                field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, propertyName, declaredFields);
                if (field == null) {
                    String temp = propertyName;
                    propertyName = methodName.substring(3);
                    field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, propertyName, declaredFields);
                    if (field == null) {
                        propertyName = temp; //�����޸Ĵ��������Ӱ��
                    }
                }
            } else if (c3 == 'f') {
                propertyName = methodName.substring(3);
            ...
            if (field == null && types[0] == boolean.class) {
                ...
                field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, isFieldName, declaredFields);
            }
            ...
            if (field != null) {
                ...
                if (fieldAnnotation != null) {
                    ...
                    if (fieldAnnotation.name().length() != 0) {
                        ...
                        add(fieldList, new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, method, field, clazz, type, ordinal,
            ...
            add(fieldList, new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, method, field, clazz, type, ordinal, serialzeFeatures, parserFeatures,
            ...
            if (builderClass == null && methodName.startsWith("get") && Character.isUpperCase(methodName.charAt(3))) {
                ...
                if (Collection.class.isAssignableFrom(method.getReturnType()) //
                    ...
                    if (annotation != null && annotation.name().length() > 0) {
                        ...
                        Field field = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getField(clazz, propertyName, declaredFields);
                        if (field != null) {
                            JSONField fieldAnnotation = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(field, JSONField.class);
                    ...
                    mutants.v36.com.alibaba.fastjson.util.FieldInfo fieldInfo = getField(fieldList, propertyName);
                    if (fieldInfo != null) {
                        continue;
                    }

                    add(fieldList, new mutants.v36.com.alibaba.fastjson.util.FieldInfo(propertyName, method, null, clazz, type, 0, 0, 0, annotation, null, null, genericInfo));
                }
            }
        }

        if (fieldList.size() == 0) {
            if (mutants.v36.com.alibaba.fastjson.util.TypeUtils.isXmlField(clazz)) {
                fieldBased = true;
            }
    ...
    private static void computeFields(Class<?> clazz, Type type, PropertyNamingStrategy propertyNamingStrategy, List<mutants.v36.com.alibaba.fastjson.util.FieldInfo> fieldList, Field[] fields) {
        Map<TypeVariable, Type> genericInfo = buildGenericInfo(clazz);
    ...
    public static Constructor<?> getCreatorConstructor(Constructor[] constructors) {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            if (annotation != null) {
                ...
                creatorConstructor = constructor;
                // ��Ӧ��break�����������췽���ϴ��� JSONCreator ע��ʱ�������ᴥ�������쳣�׳�
            }
        }
        if (creatorConstructor != null) {
        ...
        for (Constructor constructor : constructors) {
            Annotation[][] paramAnnotationArrays = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getParameterAnnotations(constructor);
    ...
    private static Method getFactoryMethod(Class<?> clazz, Method[] methods, boolean jacksonCompatible) {
        ...
        for (Method method : methods) {
            ...
            JSONCreator annotation = mutants.v36.com.alibaba.fastjson.util.TypeUtils.getAnnotation(method, JSONCreator.class);
            if (annotation != null) {
                ...
                // ��Ӧ��break����������̬���������ϴ��� JSONCreator ע��ʱ�������ᴥ�������쳣�׳�
            }
        }

        if (factoryMethod == null && jacksonCompatible) {
            for (Method method : methods) {
                if (mutants.v36.com.alibaba.fastjson.util.TypeUtils.isJacksonCreator(method)) {
                    factoryMethod = method;
                    break;
                }
            }
