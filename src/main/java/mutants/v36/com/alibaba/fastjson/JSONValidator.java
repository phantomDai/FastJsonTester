...
public abstract class JSONValidator implements Cloneable {
    ...
    void error() {
        throw new mutants.v36.com.alibaba.fastjson.JSONException("error : " + pos);
    }
    ...
    static class UTF8InputStreamValidator extends JSONValidator {
            ...
            if (pos < end) {
                ...
                if (!eof) {
                    ...
                    try {
                        ...
                        throw new mutants.v36.com.alibaba.fastjson.JSONException("read error");
                    }
        ...
        void error() {
            throw new mutants.v36.com.alibaba.fastjson.JSONException("error, readCount " + readCount + ", valueCount : " + count + ", pos " + pos);
        }
