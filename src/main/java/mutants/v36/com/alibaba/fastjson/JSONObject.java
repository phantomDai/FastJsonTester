 ...
 */
package mutants.v36.com.alibaba.fastjson;

import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToBigDecimal;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToBigInteger;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToBoolean;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToByte;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToBytes;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToDate;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToDouble;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToFloat;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToInt;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToLong;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToShort;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToSqlDate;
import static mutants.v36.com.alibaba.fastjson.util.TypeUtils.castToTimestamp;
 ...
 */
public class JSONObject extends mutants.v36.com.alibaba.fastjson.JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
    ...
    public JSONObject getJSONObject(String key) {
        ...
        if (value instanceof String) {
            return mutants.v36.com.alibaba.fastjson.JSON.parseObject((String) value);
        }

        return (JSONObject) toJSON(value);
    }

    public mutants.v36.com.alibaba.fastjson.JSONArray getJSONArray(String key) {
        Object value = map.get(key);

        if (value instanceof mutants.v36.com.alibaba.fastjson.JSONArray) {
            return (mutants.v36.com.alibaba.fastjson.JSONArray) value;
        }

        if (value instanceof List) {
            return new mutants.v36.com.alibaba.fastjson.JSONArray((List) value);
        }

        if (value instanceof String) {
            return (mutants.v36.com.alibaba.fastjson.JSONArray) mutants.v36.com.alibaba.fastjson.JSON.parse((String) value);
        }
    ...
    public <T> T toJavaObject(Class<T> clazz) {
        if (clazz == Map.class || clazz == JSONObject.class || clazz == mutants.v36.com.alibaba.fastjson.JSON.class) {
            return (T) this;
        }

        if (clazz == Object.class && !containsKey(mutants.v36.com.alibaba.fastjson.JSON.DEFAULT_TYPE_KEY)) {
            return (T) this;
        }
