...
public class JSONSerializer extends SerializeFilterable {
    ...
    protected IdentityHashMap<Object, mutants.v36.com.alibaba.fastjson.serializer.SerialContext> references  = null;
    protected mutants.v36.com.alibaba.fastjson.serializer.SerialContext context;
    ...
    public mutants.v36.com.alibaba.fastjson.serializer.SerialContext getContext() {
        return context;
    }

    public void setContext(mutants.v36.com.alibaba.fastjson.serializer.SerialContext context) {
        this.context = context;
    }

    public void setContext(mutants.v36.com.alibaba.fastjson.serializer.SerialContext parent, Object object, Object fieldName, int features) {
        this.setContext(parent, object, fieldName, features, 0);
    }

    public void setContext(mutants.v36.com.alibaba.fastjson.serializer.SerialContext parent, Object object, Object fieldName, int features, int fieldFeatures) {
        if (out.disableCircularReferenceDetect) {
            return;
        }

        this.context = new mutants.v36.com.alibaba.fastjson.serializer.SerialContext(parent, object, fieldName, features, fieldFeatures);
        if (references == null) {
            references = new IdentityHashMap<Object, mutants.v36.com.alibaba.fastjson.serializer.SerialContext>();
        }
    ...
    public boolean containsReference(Object value) {
        ...
        mutants.v36.com.alibaba.fastjson.serializer.SerialContext refContext = references.get(value);
        if (refContext == null) {
            return false;
        }
    ...
    public void writeReference(Object object) {
        mutants.v36.com.alibaba.fastjson.serializer.SerialContext context = this.context;
        ...
        mutants.v36.com.alibaba.fastjson.serializer.SerialContext parentContext = context.parent;
