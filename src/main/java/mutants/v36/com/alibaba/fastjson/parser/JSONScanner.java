...
public final class JSONScanner extends JSONLexerBase {
    ...
    public byte[] bytesValue() {
        if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.HEX) {
    ...
    private boolean scanISO8601DateIfMatch(boolean strict, int rest) {
        ...
        if ((!strict) && rest > 13) {
            ...
            if (c0 == '/' && c1 == 'D' && c2 == 'a' && c3 == 't' && c4 == 'e' && c5 == '(' && c_r0 == '/'
                ...
                token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.LITERAL_ISO8601_DATE;
                return true;
            }
        }
...
//                : text.substring(0, 65536));
            ...
            if (ch == '\\') {
                ...
                if (braceCnt == -1) {
                    ...
                    if (this.bp == text.length()) {
                        this.ch = EOI;
                        this.token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.EOF;
                        return;
                    }
                    ...
                    if (this.ch == ',') {
                        ...
                        nextToken(mutants.v36.com.alibaba.fastjson.parser.JSONToken.COMMA);
                    }
                    return;
                }
            }
    ...
    public boolean seekArrayToItem(int index) {
        ...
        if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.EOF) {
            return false;
        }
...
//        nextToken();
        ...
        for (int i = 0; i < index; ++i) {
            ...
            if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.COMMA) {
                continue;
            } else if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACKET) {
                return false;
            } else {
                throw new UnsupportedOperationException();
            }
    ...
    public int seekObjectToField(long fieldNameHash, boolean deepScan) {
        if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.EOF) {
            return mutants.v36.com.alibaba.fastjson.parser.JSONLexer.NOT_MATCH;
        }

        if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACE || token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACKET) {
            nextToken();
            return mutants.v36.com.alibaba.fastjson.parser.JSONLexer.NOT_MATCH;
        }

        if (token != mutants.v36.com.alibaba.fastjson.parser.JSONToken.LBRACE && token != mutants.v36.com.alibaba.fastjson.parser.JSONToken.COMMA) {
            throw new UnsupportedOperationException(mutants.v36.com.alibaba.fastjson.parser.JSONToken.name(token));
        }
        ...
        for (;;) {
            ...
            if (hash == fieldNameHash) {
                ...
                if (ch == ':') {
                    ...
                    if (ch == ',') {
                        ...
                        nextToken(mutants.v36.com.alibaba.fastjson.parser.JSONToken.LITERAL_INT);
                    }
                }
                return VALUE;
            }
            ...
            if (ch == '-' || ch == '+' || (ch >= '0' && ch <= '9')) {
                ...
                skipObject(false);
                if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACE) {
                    return mutants.v36.com.alibaba.fastjson.parser.JSONLexer.NOT_MATCH;
                }
            } else if (ch == '[') {
                next();
    ...
    public int seekObjectToField(long[] fieldNameHash) {
        ...
        for (;;) {
            if (ch == '}') {
                next();
                nextToken();
                this.matchStat = mutants.v36.com.alibaba.fastjson.parser.JSONLexer.NOT_MATCH;
                return -1;
            }
            if (ch == EOI) {
