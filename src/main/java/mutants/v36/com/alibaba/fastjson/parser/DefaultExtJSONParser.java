...
public class DefaultExtJSONParser extends DefaultJSONParser {
    ...
    public DefaultExtJSONParser(String input){
        this(input, mutants.v36.com.alibaba.fastjson.parser.ParserConfig.getGlobalInstance());
    }

    public DefaultExtJSONParser(String input, mutants.v36.com.alibaba.fastjson.parser.ParserConfig mapping){
        super(input, mapping);
    }

    public DefaultExtJSONParser(String input, mutants.v36.com.alibaba.fastjson.parser.ParserConfig mapping, int features){
