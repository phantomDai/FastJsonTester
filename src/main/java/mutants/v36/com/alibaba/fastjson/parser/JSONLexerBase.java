...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
    ...
    public JSONLexerBase(int features){
        ...
        if ((features & mutants.v36.com.alibaba.fastjson.parser.Feature.InitStringFieldAsEmpty.mask) != 0) {
            stringDefaultValue = "";
        }
    ...
    public final void nextToken() {
        ...
        for (;;) {
            ...
            switch (ch) {
                case '\'':
                    if (!isEnabled(mutants.v36.com.alibaba.fastjson.parser.Feature.AllowSingleQuotes)) {
    ...
    public final void nextToken(int expect) {
        ...
        for (;;) {
            switch (expect) {
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.LBRACE:
                    if (ch == '{') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.LBRACE;
                        next();
                        return;
                    }
                    if (ch == '[') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.LBRACKET;
                        next();
                        return;
                    }
                    break;
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.COMMA:
                    if (ch == ',') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.COMMA;
                        next();
                        return;
                    }

                    if (ch == '}') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACE;
                        next();
                        return;
                    }

                    if (ch == ']') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACKET;
                        next();
                        return;
                    }

                    if (ch == EOI) {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.EOF;
                        return;
                    }
                    ...
                    break;
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.LITERAL_INT:
                    if (ch >= '0' && ch <= '9') {
                        pos = bp;
                        scanNumber();
                        return;
                    ...
                    break;
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.LITERAL_STRING:
                    if (ch == '"') {
                        pos = bp;
                        scanString();
                        return;
                    ...
                    break;
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.LBRACKET:
                    if (ch == '[') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.LBRACKET;
                        next();
                        return;
                    ...
                    break;
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACKET:
                    if (ch == ']') {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.RBRACKET;
                        next();
                        return;
                    }
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.EOF:
                    if (ch == EOI) {
                        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.EOF;
                        return;
                    }
                    break;
                case mutants.v36.com.alibaba.fastjson.parser.JSONToken.IDENTIFIER:
                    nextIdent();
                    return;
                default:
                    break;
    ...
    public final String tokenName() {
        return mutants.v36.com.alibaba.fastjson.parser.JSONToken.name(token);
    }
    ...
    public void config(mutants.v36.com.alibaba.fastjson.parser.Feature feature, boolean state) {
        features = mutants.v36.com.alibaba.fastjson.parser.Feature.config(features, feature, state);
    ...
    public final boolean isEnabled(mutants.v36.com.alibaba.fastjson.parser.Feature feature) {
    ...
    public final String scanSymbol(final mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable) {
        skipWhitespace();
    ...
    public final String scanSymbol(final mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable, final char quote) {
        int hash = 0;
    ...
    public final String scanSymbolUnQuoted(final mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable) {
        if (token == mutants.v36.com.alibaba.fastjson.parser.JSONToken.ERROR && pos == 0 && bp == 1) {
            bp = 0; // adjust
        }
        ...
        this.ch = charAt(bp);
        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.IDENTIFIER;
    ...
    public final void scanString() {
        ...
        token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.LITERAL_STRING;
        this.ch = next();
    }
    ...
    public String scanTypeName(mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable) {
        return null;
    }
    ...
    public final boolean matchField(char[] fieldName) {
        ...
        if (ch == '{') {
            ...
            bp += 3;
            ch = charAt(bp);
            token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.SET;
        } else {
            nextToken();
        }
    ...
    public abstract String addSymbol(int offset, int len, int hash, final mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable);
    ...
    public Enum<?> scanEnum(Class<?> enumClass, final mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable, char serperator) {
    ...
    public String scanSymbolWithSeperator(final mutants.v36.com.alibaba.fastjson.parser.SymbolTable symbolTable, char serperator) {
        matchStat = UNKNOWN;
...
//            value = new BigInteger(chars, )
    ...
    public Date scanFieldDate(char[] fieldName) {
        ...
        if (chLocal == '"'){
            ...
            mutants.v36.com.alibaba.fastjson.parser.JSONScanner dateLexer = new mutants.v36.com.alibaba.fastjson.parser.JSONScanner(stringVal);
            try {
    ...
    public Date scanDate(char seperator) {
        ...
        if (chLocal == '"'){
            ...
            mutants.v36.com.alibaba.fastjson.parser.JSONScanner dateLexer = new JSONScanner(stringVal);
            try {
                if (dateLexer.scanISO8601DateIfMatch(false)) {
                    Calendar calendar = dateLexer.getCalendar();
                    dateVal = calendar.getTime();
    ...
    public final void scanTrue() {
        ...
        if (ch == ' '  ||
            ...
            ch == ':'  ||
            ch == '/') {
            token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.TRUE;
        } else {
    ...
    public final void scanNullOrNew(boolean acceptColon) {
        ...
        if (ch == 'u') {
            ...
            if (ch == ' '
                ...
                token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.NULL;
            } else {
        ...
        if (ch == ' '  ||
            ...
            ch == '\f' ||
            ch == '\b') {
            token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.NEW;
        } else {
    ...
    public final void scanFalse() {
        ...
        if (ch == ' '  ||
            ...
            ch == ':'  ||
            ch == '/') {
            token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.FALSE;
        } else {
    ...
    public final void scanIdent() {
        ...
        for (;;) {
            ...
            if ("null".equalsIgnoreCase(ident)) {
                ...
                token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.UNDEFINED;
            } else if ("Set".equals(ident)) {
                token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.SET;
            } else if ("TreeSet".equals(ident)) {
                token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.TREE_SET;
            } else {
                token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.IDENTIFIER;
            }
            return;
    ...
    public final void scanHex() {
        ...
        if (ch == '\'') {
            next();
            token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.HEX;
            return;
        }
    ...
    public final void scanNumber() {
        ...
        if (isDouble) {
            token = mutants.v36.com.alibaba.fastjson.parser.JSONToken.LITERAL_FLOAT;
        } else {
