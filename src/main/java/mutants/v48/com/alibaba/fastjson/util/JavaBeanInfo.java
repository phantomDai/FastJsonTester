...
import mutants.v48.com.alibaba.fastjson.annotation.JSONCreator;
import mutants.v48.com.alibaba.fastjson.annotation.JSONField;
import mutants.v48.com.alibaba.fastjson.annotation.JSONPOJOBuilder;
...
public class JavaBeanInfo {
    ...
    public static JavaBeanInfo build(Class<?> clazz //
        ...
        for (Method method : methods) { //
            ...
            if (annotation == null && !methodName.startsWith("set")) { // TODO "set"���жϷ��� JSONField ע����棬��˼������� setter ������� JSONField ע�⣿
                continue;
            }
