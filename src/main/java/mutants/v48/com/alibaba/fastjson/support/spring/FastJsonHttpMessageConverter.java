package mutants.v48.com.alibaba.fastjson.support.spring;

import mutants.v48.com.alibaba.fastjson.JSON;
import mutants.v48.com.alibaba.fastjson.JSONException;
import mutants.v48.com.alibaba.fastjson.JSONPObject;
...
import mutants.v48.com.alibaba.fastjson.support.config.FastJsonConfig;
...
public class FastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object>//
    ...
    protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        try {
            ...
            //revise 2017-10-23 ,
            // ����ԭ�е�MappingFastJsonValue�����contentType�����޸� ���־ɰ���ݡ�
            // �����µ�JSONPObject�����ر�׼��contentType��application/javascript �������Ƿ���function�����ж�
