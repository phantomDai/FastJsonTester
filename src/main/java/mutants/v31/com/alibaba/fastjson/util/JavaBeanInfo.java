...
import mutants.v31.com.alibaba.fastjson.annotation.JSONCreator;
import mutants.v31.com.alibaba.fastjson.annotation.JSONField;
import mutants.v31.com.alibaba.fastjson.annotation.JSONPOJOBuilder;
...
public class JavaBeanInfo {
    ...
    public static JavaBeanInfo build(Class<?> clazz //
        ...
        if (defaultConstructor == null || isInterfaceOrAbstract) {
            ...
            factoryMethod = getFactoryMethod(clazz, methods); // ���ڱ�� JSONCreator ע��Ĺ�������
        ...
        for (Method method : methods) { //
            ...
            if (!methodName.startsWith("set")) { // TODO "set"���жϷ��� JSONField ע����棬��˼������� setter ������� JSONField ע�⣿
                continue;
            }
