...
import static mutants.v31.com.alibaba.fastjson.util.ASMUtils.desc;
import static mutants.v31.com.alibaba.fastjson.util.ASMUtils.type;
...
import mutants.v31.com.alibaba.fastjson.asm.ClassWriter;
import mutants.v31.com.alibaba.fastjson.asm.FieldWriter;
import mutants.v31.com.alibaba.fastjson.asm.Label;
import mutants.v31.com.alibaba.fastjson.asm.MethodVisitor;
import mutants.v31.com.alibaba.fastjson.asm.MethodWriter;
import mutants.v31.com.alibaba.fastjson.asm.Opcodes;
import mutants.v31.com.alibaba.fastjson.parser.DefaultJSONParser;
import mutants.v31.com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask;
...
import mutants.v31.com.alibaba.fastjson.util.ASMClassLoader;
import mutants.v31.com.alibaba.fastjson.util.FieldInfo;
import mutants.v31.com.alibaba.fastjson.util.JavaBeanInfo;
import mutants.v31.com.alibaba.fastjson.util.TypeUtils;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.parser.JSONLexerBase.VALUE_NULL);
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.asm.Type.getType(desc(itemClass)));
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.parser.JSONToken.LBRACKET);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "nextToken", "(I)V");
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.parser.JSONLexerBase.END);
...
//                mw.visitLabel(enumNull_);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.asm.Type.getType(desc(itemType)));
        mw.visitInsn(ICONST_0);
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.parser.DefaultJSONParser.NeedToResolve);
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.parser.DefaultJSONParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                mw.visitLdcInsn(mutants.v31.com.alibaba.fastjson.asm.Type.getType(desc(fieldInfo.fieldClass)));
            } else {
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(JavaBeanDeserializer.class), "getFieldType",
